...
extension DBManager{
    ...
    public func replaceTemplateRowIfNeeded(template: DBTemplateModel) -> Int {
        ...
        let query = "REPLACE INTO \(TABLE_TEMPLATE) (\(TEMPLATE_NAME), \(CATEGORY), \(RATIO_ID), \(THUMB_SERVER_PATH), \(THUMB_LOCAL_PATH), \(THUMB_TIME), \(TOTAL_DURATION), \(SEQUENCE), \(IS_PREMIUM), \(CATEGORY_TEMP), \(DATA_PATH), \(SERVER_TEMPLATE_ID), \(IS_DETAILS_DOWNLOAD), \(IS_RELEASED), \(COLOR_PALLETE_ID), \(FONT_SET_ID), \(EVENT_DATA), \(EVENT_TIME), \(VENUE), \(NAME1), \(NAME2), \(RSVP), \(BASE_COLOR), \(LAYOUT_ID), \(EVENT_ID), \(TEMPLATE_STATUS), \(ORIGINAL_TEMPLATE), \(TEMPLATE_EVENT_STATUS), \(SOFT_DELETE), \(EVENT_TEMPLATE_JSON), \(USER_ID), \(EVENT_START_DATE), \(SHOW_WATERMARK), \(OUTPUT_TYPE)) VALUES ('\(template.templateName)', '\(template.category)', '\(template.ratioId)', '\(template.thumbServerPath)', '\(template.thumbLocalPath)', '\(template.thumbTime)', '\(template.totalDuration)', '\(template.sequence_Temp)', '\(template.isPremium)', '\(template.categoryTemp)', '\(template.dataPath)', '\(template.templateId)', '\(template.isDetailDownloaded)', '\(template.isRelease)', '\(template.colorPalleteId)', '\(template.fontSetId)', '\(template.eventData)', '\(template.eventTime)', '\(template.venue)', '\(template.name1)', '\(template.name2)', '\(template.rsvp)', '\(template.baseColor)', '\(template.layoutId)', '\(template.eventId)', '\(template.templateStatus)','\(template.originalTemplate)','\(template.templateEventStatus)','\(template.softDelete)','\(template.eventTemplateJson)', '\(template.userId)', '\(template.eventStartDate)', '\(template.showWatermark)', '\(template.outputType)' )"
