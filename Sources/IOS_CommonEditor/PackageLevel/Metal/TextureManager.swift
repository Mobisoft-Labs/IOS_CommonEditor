...
//    var logger: PackageLogger?
    ...
    func matchingTexture(to texture: MTLTexture,
        ...
        matchingDescriptor.usage = [.shaderRead , .shaderWrite , .renderTarget]
    ...
    func cgImage(from texture: MTLTexture) throws -> CGImage {
        ...
        let bitmapInfo = CGBitmapInfo(rawValue: CGBitmapInfo.byteOrder32Little.rawValue | CGImageAlphaInfo.premultipliedLast.rawValue)
